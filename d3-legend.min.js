        ...
        b.exports = function() {
            function a(a) {
                ...
                var x = w.selectAll("." + l + "cell").data(v.data),
                    ...
                    z = (y.append(e).attr("class", l + "swatch"), x.select("g." + l + "cell " + e));
                d.d3_addEvents(y, u), x.exit().transition().style("opacity", 0).remove(), d.d3_drawShapes(e, z, g, f, h, b), d.d3_addText(w, y, v.labels, l);
                var A = x.select("text"),
                ...
                }), d.d3_placement(s, x, C, A, D, q), d.d3_title(a, w, n, l), x.transition().style("opacity", 1)
            }
    ...
    2: [function(a, b, c) {
        b.exports = {
            ...
            d3_addText: function(a, b, c, d) {
                b.append("text").attr("class", d + "label"), a.selectAll("g." + d + "cell text." + d + "label").data(c).text(this.d3_identity)
            },
        ...
        b.exports = function() {
            function a(a) {
                ...
                var u = t.selectAll("." + j + "cell").data(s.data),
                    ...
                    w = (v.append(e).attr("class", j + "swatch"), u.select("g." + j + "cell " + e));
                d.d3_addEvents(v, r), u.exit().transition().style("opacity", 0).remove(), "line" === e ? (d.d3_drawShapes(e, w, 0, f), w.attr("stroke-width", s.feature)) : d.d3_drawShapes(e, w, s.feature, s.feature, s.feature, b), d.d3_addText(t, v, s.labels, j);
                ...
                }), d.d3_placement(p, u, x, z, y, n), d.d3_title(a, t, k, j), u.transition().style("opacity", 1)
            }
            var b, c = d3.scale.linear(),
                e = "rect",
                f = 15,
        ...
        b.exports = function() {
            function a(a) {
                ...
                var v = u.selectAll("." + k + "cell").data(t.data),
                    ...
                    x = (w.append(c).attr("class", k + "swatch"), v.select("g." + k + "cell " + c));
                d.d3_addEvents(w, s), v.exit().transition().style("opacity", 0).remove(), d.d3_drawShapes(c, x, f, e, g, t.feature), d.d3_addText(u, w, t.labels, k);
                ...
                }), d.d3_placement(q, v, y, A, z, n), d.d3_title(a, u, l, k), v.transition().style("opacity", 1)
            }
